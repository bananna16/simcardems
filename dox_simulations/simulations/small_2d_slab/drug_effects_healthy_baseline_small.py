...
outdir = here.parent.parent / "results/results_healthy_baseline_small"

# Specify paths to the geometry that we will use
geometry_path = here.parent.parent / "data/geometries/small_2d_slab/slab.h5"
geometry_schema_path = here.parent.parent / "data/geometries/small_2d_slab/slab.json"
...
#popu_factors_path = here.parent.parent / "data/population_factors/representative_female.json"
